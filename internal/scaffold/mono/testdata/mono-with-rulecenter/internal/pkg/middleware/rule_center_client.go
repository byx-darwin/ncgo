...
import (
	...
	"github.com/x/demo/kitex_gen/api/ratelimit/v1/ruleservice"
)
...
// NewRuleCenterClientWithTimeout creates a client with a custom per-call
// RPC timeout.
...
// NewRuleCenterClientWithConfig creates a client with explicit timeout
...
func (c *RuleCenterClient) ResolveRateLimitRule(ctx context.Context, lookup ratelimit.Lookup) (*conf.RateLimitRuleConfig, bool, error) {
	resp, err := c.cli.GetRule(ctx, &ratelimitv1.GetRuleReq{
