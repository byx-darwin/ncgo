...
func TestServeInitializeAndToolsList(t *testing.T) {
	...
	for _, want := range []string{"ncgo_version", "ncgo_doctor", "ncgo_ai_init_claude", "ncgo_ai_sync", "ncgo_i18n_report", "ncgo_i18n_check", "ncgo_protolint", "ncgo_add_infra", "ncgo_add_method", "ncgo_add_rpc_method"} {
